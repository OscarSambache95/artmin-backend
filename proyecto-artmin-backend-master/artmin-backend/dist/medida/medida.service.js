...
let MedidaService = class MedidaService extends principal_service_1.PrincipalService {
    constructor(_medidaRepository) {
        super(_medidaRepository, medida_entity_1.MedidaEntity);
