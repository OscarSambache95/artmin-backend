...
let ChartController = class ChartController extends principal_controller_1.PrincipalAbstractController {
    constructor(_chartService) {
        super(_chartService);
    ...
    obtenerCharts(datosConsultaCharts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existeDatos) {
                return yield this._chartService.obtenerCharts(JSON.parse(datosConsultaCharts));
            }
            else {
...
__decorate([
    common_1.Get('obtener-charts-lugar-plataforma'),
    __param(0, common_1.Query('datosConsulta')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ChartController.prototype, "obtenerCharts", null);
