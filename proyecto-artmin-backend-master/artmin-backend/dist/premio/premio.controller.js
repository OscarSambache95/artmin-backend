...
let PremioController = class PremioController extends principal_controller_1.PrincipalAbstractController {
    constructor(_premioService) {
        super(_premioService);
        this._premioService = _premioService;
    }
};
PremioController = __decorate([
    common_1.Controller('premio'),
