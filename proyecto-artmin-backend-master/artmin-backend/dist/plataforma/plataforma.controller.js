...
let PlataformaController = class PlataformaController extends principal_controller_1.PrincipalAbstractController {
    constructor(_plataformaService) {
        super(_plataformaService);
        this._plataformaService = _plataformaService;
    }
};
PlataformaController = __decorate([
    common_1.Controller('plataforma'),
